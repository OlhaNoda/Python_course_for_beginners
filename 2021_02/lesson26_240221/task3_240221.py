...
def hybrid_quick_sort_helper(array, first, last):
    ...
    while first < last:
        ...
        # если размер массива больше, чем установленный порог 10 применяем быструю сортировку
            ...
            # если левая сторона относительно опорной точки меньше, чем правая, делаем ее гибридную сортировку
            # перемещаемся в правую часть массива
            if pivot - first < last - pivot:
                hybrid_quick_sort_helper(array, first, pivot - 1)
                first = pivot + 1
            # если правая сторона относительно опорной точки меньше, чем левая, делаем ее гибридную сортировку
