...
Есть json файл, в котором находится информация о координатах объектов. Координаты перепутаны местами.
Необходимо реализовать функционал, который редактирует данные в файле - меняет местами широту и долготу.
"""
import json
